  ...
  connectedCallback() {
    this.innerHTML = `
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="qualifications.html"><i class='app-menu__icon bx bx-book'></i>
                    <span class="app-menu__label">Trình độ - Ngoại ngữ </span></a>
            </li>
 ...
 <div id="myModal" class="modal" class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
  ...
  updateActiveLink() {
    ...
    menuItems.forEach(item => {
      ...
      if (currentPath.includes('language') && linkPath.includes('qualifications.html')) {
        item.classList.add('active');
      }
