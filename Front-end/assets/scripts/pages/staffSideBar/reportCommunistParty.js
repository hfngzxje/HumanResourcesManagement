...
var locTheo = [
  ...
  { label: "Năm tuổi đảng", value: 'Năm tuổi đảng' },
];
var QueQuan = [
  { label: "Quê quán", value: "Quê quán" },
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const namerTuoiDangInput = document.querySelector(
    'base-input-number[description="Năm tuổi đảng"]'
  );
  ...
  function toggleInputs(enabled) {
    ...
    namerTuoiDangInput.disabled = !enabled;
  }
...
function handleSearch() {
  ...
  if(formValue.searchRules === "Năm tuổi đảng"){
    params.NamTuoiDang = formValue.NamTuoiDang
  }
...
function handleSelectFilterBy() {
  ...
  const namTuoiDangEl = document.querySelector("#namtuoidang input");
